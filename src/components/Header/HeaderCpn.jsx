  ...
  return (
    <header className="header">
      <div className="container">
        <div className="banner p-bt32 b-bt">
          <img src="/img/banner.jpg" alt="" />
        </div>
        <div className="header__between m-tb32">
          <div className="header__between-title">
            <h2 className="heading-h3">
              TẠP CHÍ ĐIỆN TỬ CỦA TỔNG HỘI NÔNG NGHIỆP VIỆT NAM
            </h2>
          ...
          <div className="header__between-socials">
            ...
            <div className="sign">
              <div className="sign__buttons">
                <a href="#" className="sign__buttons-item login">
                  ĐĂNG NHẬP
                </a>
                <a href="#" className="sign__buttons-item register">
                  ĐĂNG KÝ
                </a>
              </div>
